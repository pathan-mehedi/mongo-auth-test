...
import { regirsterNewUser } from "@/services/signup";
...
const signup = () => {
    ...
    async function handleSubmit(e) {
        const data = await regirsterNewUser(formData);
        console.log(data);
        e.preventDefault();
    ...
    xl:px-5 lg:flex-row'>
          ...
          fill-current'>
                            ...
                            <svg
                                viewbox='0 0 91 91'
                                class='absolute bottom-0 right-0 z-0 w-32 h-32 -mb-12 -mr-12 text-teal-600
          fill-current'>
                                <g
                                    stroke='none'
                                    strokewidth='1'
